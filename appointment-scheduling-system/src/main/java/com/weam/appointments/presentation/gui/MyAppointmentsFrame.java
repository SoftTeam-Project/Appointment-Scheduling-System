...
public class MyAppointmentsFrame {

    public MyAppointmentsFrame(String username, JFrame previousFrame) {
        ...
        String[] columns = {
                "ID", "Slot ID", "Date", "Time",
                "Duration", "Participants", "Type", "Status"
        };
        ...
        List<Appointment> appointments =
                bookingService.findFutureAppointmentsByUser(username);
